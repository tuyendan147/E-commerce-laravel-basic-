				...
				<div class="wrapper">
					...
					<div class="product-sec1">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{!!url('public/images/m1.jpg')!!}" alt="">
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html">Hạnh nhân, 100g</a>
									</h4>
									<div class="info-product-price">
										<span class="item_price">300.000 đồng</span>
										<del>500.000 đồng</del>
									</div>
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="#" method="post">
											<fieldset>
												...
												<input type="hidden" name="item_name" value="hạnh nhân, 100g" />
												<input type="hidden" name="amount" value="300.000₫" />
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{!!url('public/images/m2.jpg')!!}"="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Xem qua</a>
										</div>
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html">Hạt điều, 100g</a>
									</h4>
									<div class="info-product-price">
										<span class="item_price">200.000 đồng</span>
										<del>420.000 đồng</del>
									</div>
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="#" method="post">
											<fieldset>
												...
												<input type="hidden" name="amount" value="200.000₫" />
												<input type="hidden" name="discount_amount" value="1.00" />
												<input type="hidden" name="currency_code" value="VND" />
												<input type="hidden" name="return" value=" " />
												<input type="hidden" name="cancel_return" value=" " />
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{!!url('public/images/m3.jpg')!!}" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Xem qua</a>
										</div>
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html">Hạt dẻ, 250g</a>
									</h4>
									<div class="info-product-price">
										<span class="item_price">100.000 đồng</span>
									...
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="#" method="post">
											<fieldset>
												...
												<input type="hidden" name="add" value="1" />
												<input type="hidden" name="business" value=" " />
												<input type="hidden" name="item_name" value="Hạt dẻ, 250g" />
					...
					<div class="product-sec1">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">	
								<div class="men-thumb-item">
									<img src="{!!url('public/images/mk4.jpg')!!}" alt="" width="93px" height="150px">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Xem qua</a>
										</div>
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html">Dầu tự do</a>
									</h4>
									<div class="info-product-price">
										<span class="item_price">78.000 đồng</span>
										<del>110.000 đồng</del>
									</div>
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="#" method="post">
											<fieldset>
												...
												<input type="hidden" name="add" value="1" />
												<input type="hidden" name="business" value=" " />
												<input type="hidden" name="item_name" value="Dầu tự do, 1L" />
												<input type="hidden" name="amount" value="78000₫" />
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{!!url('public/images/mk5.jpg')!!}" alt="" width="106px" height="150px">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Xem qua</a>
										</div>
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html">Dầu vàng, 1L</a>
									</h4>
									<div class="info-product-price">
										<span class="item_price">160.000 đồng</span>
										<del>200.000 đồng</del>
									</div>
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="#" method="post">
											<fieldset>
												...
												<input type="hidden" name="add" value="1" />
												<input type="hidden" name="business" value=" " />
												<input type="hidden" name="item_name" value="Dầu vàng, 1L" />
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{!!url('public/images/mk6.jpg')!!}" alt="" width="126px" height="150px">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Xem qua</a>
										</div>
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html">Dầu ép, 5L</a>
									</h4>
									<div class="info-product-price">
										<span class="item_price">500.000 đồng</span>
										<del>600.000</del>
									</div>
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="#" method="post">
											<fieldset>
												...
												<input type="hidden" name="add" value="1" />
												<input type="hidden" name="business" value=" " />
												<input type="hidden" name="item_name" value="Dầu ép, 5L" />
					...
					<div class="product-sec1">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{!!url('public/images/mk7.jpg')!!}" alt="" width="132px" height="150px">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Xem qua</a>
										</div>
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html">Hảo hảo, 65g</a>
									</h4>
									<div class="info-product-price">
										<span class="item_price">55.000 đồng</span>
										<del>80.000 đồng</del>
									</div>
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="#" method="post">
											<fieldset>
												...
												<input type="hidden" name="add" value="1" />
												<input type="hidden" name="business" value=" " />
												<input type="hidden" name="item_name" value="Hảo hảo, 65g" />
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{!!url('public/images/mk8.jpg')!!}" alt="" width="150px" height="150px">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Xem qua</a>
										</div>
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html">Ba miền, 500g</a>
									</h4>
									<div class="info-product-price">
										<span class="item_price">40.000 đồng</span>
										<del>60.000 đồng</del>
									</div>
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="#" method="post">
											<fieldset>
												...
												<input type="hidden" name="add" value="1" />
												<input type="hidden" name="business" value=" " />
												<input type="hidden" name="item_name" value="Ba miền, 500g" />
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{!!url('public/images/mk9.jpg')!!}" alt="" width="150px" height="150px">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Xem qua</a>
										</div>
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html">Bò rau thơm, 68g</a>
									</h4>
									<div class="info-product-price">
										<span class="item_price">111.000 đồng</span>
										<del>150.000 đồng</del>
									</div>
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="#" method="post">
											<fieldset>
												...
												<input type="hidden" name="add" value="1" />
												<input type="hidden" name="business" value=" " />
												<input type="hidden" name="item_name" value="Bò rau thơm, 68g" />
