...
<body>
	...
	<div class="ads-grid">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">SẢN PHẨM NHÀ BẾP
				...
				<div class="wrapper">
					...
					<div class="product-sec1">
						<div class="col-xs-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{!!url('public/images/k1.jpg')!!}" alt="" Width="160px" height="160px">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Xem qua</a>
										</div>
									</div>
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html">Gạo đặc sản</a>
									</h4>
									<div class="info-product-price">
										<span class="item_price">550.000 đồng</span>
										<del>700.000 đồng</del>
									</div>
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="#" method="post">
											<fieldset>
												...
												<input type="hidden" name="item_name" value="Gạo đặc sản" />
						...
						<div class="col-xs-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{!!url('public/images/k2.jpg')!!}" alt="" Width="160px" height="160px">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Xem qua</a>
										</div>
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html">Trà Hoa Sen</a>
									</h4>
									<div class="info-product-price">
										<span class="item_price">35.000 đồng</span>
										<del>50.000 đồng</del>
									</div>
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="#" method="post">
											<fieldset>
												...
												<input type="hidden" name="add" value="1" />
												<input type="hidden" name="business" value=" " />
												<input type="hidden" name="item_name" value="Trà hoa sen" />
						...
						<div class="col-xs-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{!!url('public/images/k3.jpg')!!}" alt="" Width="160px" height="160px">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Xem qua</a>
										</div>
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html">Trà lipton</a>
									</h4>
									<div class="info-product-price">
										<span class="item_price">84.000 đồng</span>
										<del>100.000 đồng</del>
									</div>
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="#" method="post">
											<fieldset>
												...
												<input type="hidden" name="add" value="1" />
												<input type="hidden" name="business" value=" " />
												<input type="hidden" name="item_name" value="Trà lipton" />
												<input type="hidden" name="amount" value="84000₫" />
												<input type="hidden" name="discount_amount" value="1.00" />
												<input type="hidden" name="currency_code" value="VND" />
												<input type="hidden" name="return" value=" " />
												<input type="hidden" name="cancel_return" value=" " />
					...
					<div class="product-sec1">
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{!!url('public/images/k4.jpg')!!}" alt="" Width="160px" height="160px">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Xem qua</a>
										</div>
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html">Hạt nêm</a>
									</h4>
									<div class="info-product-price">
										<span class="item_price">70.000 đồng</span>
										<del>90.000 đồng</del>
									</div>
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="#" method="post">
											<fieldset>
												...
												<input type="hidden" name="add" value="1" />
												<input type="hidden" name="business" value=" " />
												<input type="hidden" name="item_name" value="Hạt nêm" />
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{!!url('public/images/k5.jpg')!!}" alt="" Width="160px" height="160px">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Xem qua</a>
										</div>
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html">Tiêu tự nhiên</a>
									</h4>
									<div class="info-product-price">
										<span class="item_price">85.000 đồng</span>
										<del>90.000 đồng</del>
									</div>
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="#" method="post">
											<fieldset>
												...
												<input type="hidden" name="add" value="1" />
												<input type="hidden" name="business" value=" " />
												<input type="hidden" name="item_name" value="Tiêu tự nhiên" />
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{!!url('public/images/k6.jpg')!!}" alt="" Width="160px" height="160px">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Xem qua</a>
										</div>
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html">Bột ngọt</a>
									</h4>
									<div class="info-product-price">
										<span class="item_price">29.999 đồng</span>
										<del>42.500 đồng</del>
									</div>
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="#" method="post">
											<fieldset>
												...
												<input type="hidden" name="add" value="1" />
												<input type="hidden" name="business" value=" " />
												<input type="hidden" name="item_name" value="Bột ngọt" />
					...
					<div class="product-sec1">
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{!!url('public/images/k7.jpg')!!}" alt="" Width="160px" height="160px">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Xem qua</a>
										</div>
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html">Bánh socola</a>
									</h4>
									<div class="info-product-price">
										<span class="item_price">22.000 đồng</span>
										<del>25.000 đồng</del>
									</div>
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="#" method="post">
											<fieldset>
												...
												<input type="hidden" name="add" value="1" />
												<input type="hidden" name="business" value=" " />
												<input type="hidden" name="item_name" value="Bánh socola" />
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{!!url('public/images/k8.jpg')!!}" alt="" Width="160px" height="160px">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Xem qua</a>
										</div>
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html">Bánh nabati</a>
									</h4>
									<div class="info-product-price">
										<span class="item_price">17.500 đồng</span>
										<del>19.500</del>
									</div>
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="#" method="post">
											<fieldset>
												...
												<input type="hidden" name="add" value="1" />
												<input type="hidden" name="business" value=" " />
												<input type="hidden" name="item_name" value="Bánh nabati" />
												<input type="hidden" name="amount" value="17500₫" />
												<input type="hidden" name="discount_amount" value="1.00" />
												<input type="hidden" name="currency_code" value="VND" />
												<input type="hidden" name="return" value=" " />
												<input type="hidden" name="cancel_return" value=" " />
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{!!url('public/images/k9.jpg')!!}" alt="" Width="160px" height="160px">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Xem qua</a>
										</div>
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html">Bánh trứng Tipo</a>
									</h4>
									<div class="info-product-price">
										<span class="item_price">134.000 đồng</span>
										<del>150.000 đồng</del>
									</div>
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="#" method="post">
											<fieldset>
												...
												<input type="hidden" name="add" value="1" />
												<input type="hidden" name="business" value=" " />
												<input type="hidden" name="item_name" value="Bánh trứng TIPO" />
												<input type="hidden" name="amount" value="134000₫" />
												<input type="hidden" name="discount_amount" value="1.00" />
												<input type="hidden" name="currency_code" value="VND" />
												<input type="hidden" name="return" value=" " />
												<input type="hidden" name="cancel_return" value=" " />
					...
					<div class="product-sec1">
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{!!url('public/images/k10.jpg')!!}" alt="" Width="160px" height="160px">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Xem qua</a>
										</div>
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html">Kẹo bạc hà</a>
									</h4>
									<div class="info-product-price">
										<span class="item_price">14.000 đồng</span>
										<del>15.000 đồng</del>
									</div>
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="#" method="post">
											<fieldset>
												...
												<input type="hidden" name="add" value="1" />
												<input type="hidden" name="business" value=" " />
												<input type="hidden" name="item_name" value="Kẹo bạc hà" />
												<input type="hidden" name="amount" value="14000₫" />
												<input type="hidden" name="discount_amount" value="1.00" />
												<input type="hidden" name="currency_code" value="VND" />
												<input type="hidden" name="return" value=" " />
												<input type="hidden" name="cancel_return" value=" " />
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{!!url('public/images/k11.jpg')!!}" alt="" Width="160px" height="160px">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Xem qua</a>
										</div>
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html">Kẹo dừa Bến Tre</a>
									</h4>
									<div class="info-product-price">
										<span class="item_price">25.000 đồng</span>
										<del>35.000 đồng</del>
									</div>
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="#" method="post">
											<fieldset>
												...
												<input type="hidden" name="add" value="1" />
												<input type="hidden" name="business" value=" " />
												<input type="hidden" name="item_name" value="Kẹo dừa Bến Tre" />
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{!!url('public/images/k12.jpg')!!}" alt="" Width="160px" height="160px">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Xem qua</a>
										</div>
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html">Kẹo mè xửng Huế</a>
									</h4>
									<div class="info-product-price">
										<span class="item_price">60.000 đồng</span>
										<del>70.000 đồng</del>
									</div>
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="#" method="post">
											<fieldset>
												...
												<input type="hidden" name="add" value="1" />
												<input type="hidden" name="business" value=" " />
												<input type="hidden" name="item_name" value="Kẹo mè xừng Huế" />
								...
								<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
									<form action="#" method="post">
										<fieldset>
											...
											<input type="hidden" name="add" value="1" />
											<input type="hidden" name="business" value=" " />
											<input type="hidden" name="item_name" value="Rượu, 5g" />
								...
								<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
									<form action="#" method="post">
										<fieldset>
											...
											<input type="hidden" name="add" value="1" />
											<input type="hidden" name="business" value=" " />
											<input type="hidden" name="item_name" value="Cà chua, 950g" />
			...
			<div class="footer-info w3-agileits-info">
				...
				<div class="col-sm-2 footer-grids  w3l-socialmk">
					...
					<div class="agileits_app-devices">
						<h5>Tải ứng dụng</h5>
						<a href="#">
							<img src="{!!url('publicimages/1.png')!!}" alt="">
						</a>
						<a href="#">
