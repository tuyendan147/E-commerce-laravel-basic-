...
<tr class="rem3">
								...
								<td class="invert-image">
									<a href="single.html">
										<img src="{!!url('public/images/'.$row->options->img)!!}" alt=" " width="20px" height="20px" class="img-responsive">
									</a>
								</td>
								<td class="invert">
									<div class="quantity">
								...
								<td class="invert">{!! $row->price !!} đồng</td>
								<td class="invert">
									<div class="rem">
										<a href="{!! url('xoa-chi-tiet-don-hang') !!}/{!! $row->rowId !!}"><div class="close3"> </div></a>
									</div>
								</td>
							</tr>
							@endforeach
			...
			<div class="checkout-left">
				<div class="address_form_agile">
					...
					<form action="{!! url('them-don-hang') !!}" method="post" class="creditly-card-form agileinfo_form">
						 {!! csrf_field() !!}
						<div class="creditly-wrapper wthree, w3_agileits_wrapper">
							<div class="information-wrapper">
								<div class="first-row">
									<div class="controls">
										<input class="billing-address-name" type="text" name="HoTen" placeholder="Full Name" required="">
									</div>
									<div class="w3_agileits_card_number_grids">
										<div class="w3_agileits_card_number_grid_left">
											<div class="controls">
												<input type="text" placeholder="Mobile Number" name="SDT" required="">
											</div>
										</div>
								...
								<button type="submit" class="submit check_out">Giao hàng đến địa chỉ này </button>
							</div>
						</div>
					</form>
